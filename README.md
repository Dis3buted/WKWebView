...
When window is small Web Inspector open's in own window and when window is at max it's added as subview and the error happens." By Adding WKUIDelegate protocol and setting webView?.uiDelegate = self seem's to solve problem.
